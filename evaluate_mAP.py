...
def get_mAP(Yolo, dataset, score_threshold=0.25, iou_threshold=0.50, TEST_INPUT_SIZE=TEST_INPUT_SIZE):
    ...
    for index in range(dataset.num_samples):
        ...
        with open('{}/{}_ground_truth.json'.format(ground_truth_dir_path, str(index)), 'w') as outfile:
    ...
    for class_name in gt_classes:
        ...
        with open('{}/{}_predictions.json'.format(ground_truth_dir_path, class_name), 'w') as outfile:
    ...
    with open("mAP/results.txt", 'w') as results_file:
        ...
        for class_index, class_name in enumerate(gt_classes):
            ...
            predictions_file = '{}/{}_predictions.json'.format(ground_truth_dir_path, class_name)
            ...
            for idx, prediction in enumerate(predictions_data):
                ...
                gt_file = '{}/{}_ground_truth.json'.format(ground_truth_dir_path, str(file_id))
...
if __name__ == '__main__':
    if YOLO_FRAMEWORK == "tf": # TensorFlow detection
        ...
        if YOLO_CUSTOM_WEIGHTS == False:
            ...
            yolo.load_weights("./checkpoints/{}").format(TRAIN_MODEL_NAME) # use custom weights

    elif YOLO_FRAMEWORK == "trt": # TensorRT detection
        saved_model_loaded = tf.saved_model.load("./checkpoints/{}".format(TRAIN_MODEL_NAME), tags=[tag_constants.SERVING])
